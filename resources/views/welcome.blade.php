            ...
            <div class="grid grid-cols-1 gap-12 lg:grid-cols-4">
                <div class="lg:col-span-2">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-6 max-w-md">
                        PT Roda Jaya Sakti (RJS) is committed to being the premier Mining Services Contractor, providing
                ...
                <div>
                    ...
                    <ul class="space-y-4 text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <li><a href="{{ route('careers.index') }}" class="hover:text-brand-500 transition-colors">Career Portal</a></li>
                        <li><a href="{{ route('articles.index') }}" class="hover:text-brand-500 transition-colors">Company News</a></li>
